...
@section('content')
    <div class="card col-6 offset-3">
        <div class="card-body">
            ...
            <form action="{{ route('admin.techno.update',$techno->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group row mb-3">
                    <label for="first_name" class="col-3 col-form-label">Name</label>
                    <div class="col-9">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"  value="{{$techno->name}}" required ><br>
                        @error('name')
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="checkbox" value="1"  {{$techno->is_framework?'checked':''}} class="form-control" name="is_framework"><br>
                    </div>
                </div>
