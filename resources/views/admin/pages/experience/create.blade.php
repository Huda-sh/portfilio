...
@section('content')
    <div class="card col-6 offset-3">
        <div class="card-body">
            ...
            <form action="{{ route('admin.experience.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-9">
                        <input type="text" class="form-control @error('company') is-invalid @enderror" name="company"  value="{{old('company')}}" required ><br>
                        @error('company')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                     </span>
