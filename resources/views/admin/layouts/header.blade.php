...
{{--                    <span class="d-none d-sm-inline-block ml-1">{{ Auth::user()->first_name }}</span>--}}
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <form class="dropdown-item d-flex align-items-center justify-content-between" method="post" action="{{route('admin.logout')}}">
                        @csrf
                        <button style="background: none; border: none; margin-left: -5px;" type="submit">Log Out</button>
                    </form>
                </div>
            </div>
